        ...
        <div class="social">
            ...
            <!--==============================content================================-->
				<?php
                    ...
                    $query = "SELECT imagen FROM producto WHERE id_local=$id ";
                ...
                <article class="col-2" style="margin-left:10px; margin-top: 10px;">
                            <a href="#"><img class="img-border" src="" alt="" ></a>
                   <center><b style="font-family: 'Droid Sans'; font-size: 10px; color:#fff;"> Descripción de app 2 lineas o menos </b></center>
                   <center><a href=""><b style="font-family: 'Droid Sans'; font-size: 20px; color:#fff;"> x Eliminar </b> </a></center>
