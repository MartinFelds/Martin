    ...
    <section id="content"><div class="ic"></div>
        ...
        <section class="form">      
                ...
                <center> 
                    ...
                    <br>
                    <form name="nombre-de-local" action="modificar.php?id=<?php  echo $_GET['error2']?>" method="post">
                   ...
                   <center>
                    <br><br><br>
                        <form name="imagen-de-local" action="modificar.php?id=<?php  echo $_GET['error3']?>" method="post">
