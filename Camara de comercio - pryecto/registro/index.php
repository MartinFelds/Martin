    ...
    <section id="content">
        ...
        <center>
           ...
           <section class="form">
			...
			<br><br><br><br>
            <center> <b style="font-family: 'Droid Sans'; font-size: 15px; color:#fff;"> Para ser socio, debes inscribirte directamente en la cámara de comercio, pagando una cuota de inscripción, al realizar el pago podrás registrarte aquí y tener acceso. </b> </center>
