...
<body id="page1" >
    ...
    <section id="content">
        ...
        <center>
              ...
              <section class="form">			  
            <center><h1>Inscríbete</h1></center>
			<br><br><br><br>
			<b style="font-family: 'Droid Sans'; font-size: 25px; color:#FE2E2E;">Posibles Errores:</b>	<br>							
			<b style="font-family: 'Droid Sans'; font-size: 20px; color:#FE2E2E;">(1) El nombre ingresado ya existe.</b> <br>
			<b style="font-family: 'Droid Sans'; font-size: 20px; color:#FE2E2E;">(2) Rellene todos los campos requeridos.</b> <br>
            
                <form name="input" action="registro.php" method="post">
                    <input type="text" name="nombre" placeholder="Nombre del Local o Empresa">
                    <input type="text" name="rut" placeholder="RUT de la Empresa: xx.xxx.xxx-x">
                    ...
                    <input style="background: #1D6A20 " type="submit" value="Registrar">
                </form>
            </section>
