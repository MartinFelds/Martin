...
<body id="page1" >
    ...
    <header>
        <div class="row-top" >
                ...
                <div class="wrapper" style="z-index:2">
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a href="" class="active" style="font-family: 'Droid Sans'; font-size: 24px;"><b>Locales</b> </a></li>
         ...
         <br><br><br>
        <div class="row-bot" style="z-index:1">
            <div class="row-bot-bg">
                <div class="main">
                    <center><img src="../images/comercio.png" alt="" /></center>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="main">
            <div class="wrapper img-indent-bot">
                ...
                <?php
                    ...
                    session_start();
                    $query = "SELECT nombre, id, imagen, visitas FROM Local WHERE activo='1' ";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        ...
                        <article class="col-2" style="margin-left:10px; margin-top: 10px;">
                            <br>
                            <center><b style="color: #fff; font-size: 25px;">  <?php echo $row['nombre']; ?> </b></center>
                            <a href= <?php echo "../local/?id=".$row['id']; ?>  ><img class="img-border" src=<?php echo "images/".$row['imagen'].".jpg"; ?> alt=""></a>
                        </article>
